...
df_unida_extra <- df_unida5 %>% 
        ...
        mutate(num_terminacion = rowSums(cbind(base_sentencias, a_perdon, a_suspension, a_criterio, 
                a_sobreseimiento, s_libertad_falta_elementos, s_no_vinculado), na.rm = T)) %>% 
